...
#
# occamy.tcl: Tcl script for re-creating project 'occamy'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/occamy.srcs/sources_1/ip/sfifo_w16_d32/sfifo_w16_d32.xci"]"\
 "[file normalize "$origin_dir/occamy.srcs/sources_1/new/multi_user_fq.v"]"\
 "[file normalize "$origin_dir/occamy.srcs/sources_1/new/switch_qc.v"]"\
 "[file normalize "$origin_dir/occamy.srcs/sources_1/new/switch_core.v"]"\
 "[file normalize "$origin_dir/occamy.srcs/sources_1/ip/sfifo_ft_w128_d256/sfifo_ft_w128_d256.xci"]"\
 "[file normalize "$origin_dir/occamy.srcs/sources_1/ip/fifo_generator_0_1/fifo_generator_0.xci"]"\
 "[file normalize "$origin_dir/occamy.srcs/sources_1/ip/sfifo_ft_w16_d32/sfifo_ft_w16_d32.xci"]"\
 "[file normalize "$origin_dir/occamy.srcs/sources_1/ip/dpsram_w4_d512/dpsram_w4_d512.xci"]"\
 "[file normalize "$origin_dir/occamy.srcs/sources_1/ip/dpsram_w128_d2k/dpsram_w128_d2k.xci"]"\
 "[file normalize "$origin_dir/occamy.srcs/sources_1/ip/sfifo_ft_w10_d512/sfifo_ft_w10_d512.xci"]"\
 "[file normalize "$origin_dir/occamy.srcs/sources_1/ip/sram_w16_d512/sram_w16_d512.xci"]"\
 "[file normalize "$origin_dir/occamy.srcs/sim_1/new/switch_core_tb.v"]"\
 "[file normalize "$origin_dir/switch_core_tb_behav.wcfg"]"\
  ]
  foreach ifile $files {
...
# Create project
create_project ${_xil_proj_name_} $origin_dir/vivado_project -part xcu250-figd2104-2L-e -quiet -force
...
set file "sfifo_w16_d32/sfifo_w16_d32.xci"
...
set_property -name "top" -value "switch_core" -objects $obj
...
# Set 'sources_1' fileset file properties for local files
set file "sfifo_ft_w128_d256/sfifo_ft_w128_d256.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "fifo_generator_0_1/fifo_generator_0.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "sfifo_ft_w16_d32/sfifo_ft_w16_d32.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "dpsram_w4_d512/dpsram_w4_d512.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "dpsram_w128_d2k/dpsram_w128_d2k.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "sfifo_ft_w10_d512/sfifo_ft_w10_d512.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "sram_w16_d512/sram_w16_d512.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
set obj [get_filesets sim_1]
set_property -name "top" -value "switch_core_tb" -objects $obj
